...
public abstract class Vislice extends Fragment{

    /* IMPORTANT !!!!!!!!!!!!!!!!!!!!!!!!!!!!!
     * You need static methods for SHARED_PREFERENCES_VISLICE, ST_HIGH_SCORE and ST_CURRENT_SCORE!!!!
     */

    abstract public String visliceName();
    abstract public Besede besede();
    abstract public int layout();
    abstract public int mCurrentID();
    abstract public int keyboard();
    abstract public Object getCurrentFragmentManager();

    public String SHARED_PREFERENCES_VISLICE = "SHARED_PREFERENCES_VISLICE_";
    public String ST_HIGH_SCORE = "ST_HIGH_SCORE_";
    public String ST_CURRENT_SCORE = "ST_CURRENT_SCORE_";
    public String ST_PRESKOK = "ST_PRESKOK_";
    public String ST_DVE_CRKI = "ST_DVE_CRKI_";
    public String ST_CRKA = "ST_CRKA_";

    public String ST_CURRENT_WORD = "ST_CURRENT_WORD_";
    public String ST_CURRENT_KNOWN_CHARS = "ST_CURRENT_KNOWN_CHARS_";
    public String ST_CURRENT_ZGRESENIH = "ST_ZGRESENIH_";
    public String ST_NEXT_PERK = "ST_NEXT_PERK_";

    public int V_ST_ZGRESENIH = 9, V_ST_PRESKOK = 11, V_ST_DVE_CRKI = 6, V_ST_CRKA = 3;

    public ImageView mVislice;
    public TextView mBeseda, mCurrent;

    public Button a, b, c, cc, d, e, f, g, h, i, j, k, l, m, n, o, p, r, s, ss, t, u, v, z, zz, q , w, y, x;
    public Button mPreskok, mDveCrki, mCrka;

    public String beseda = null, trenutna_beseda = null, trenutno_znano = null;

    public int st_zgresenih = 0, st_count = 0, st_highestScore = 0;
    public int preskok = 0, dve_crki = 0, crka = 0, next = 0;

    public Handler handler = new Handler();
    public Besede besede = null;
    public Random random = new Random(System.currentTimeMillis());

    public enum Keyboards{SLOVENIAN, ENGLISH}
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        initialize_shared_preferences_names();
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mVislice = (ImageView) view.findViewById(mVisliceID());
        mVislice.setImageResource(mVisliceSetImageResource());

        mBeseda = (TextView) view.findViewById(mBesedaID());
        if(trenutno_znano != null) {
            mBeseda.setText(trenutno_znano);

        }

        mCurrent = (TextView) view.findViewById(mCurrentID());
    ...
    public int mCrkaID() {
        return R.id.vislice_crka;
    }

    public int mDveCrkiID() {
        return R.id.vislice_dve_crki;
    }

    public int mPreskokID() {
        return R.id.vislice_skok;
    }

    public int mBesedaID() {
        return R.id.vislice_beseda;
    }

    public int mVisliceID() {
        return R.id.vislice_image;
    }

    public int mVisliceSetImageResource() {
        return R.drawable.vislice1;
    }
    ...
    public void initialize_shared_preferences_names() {
        if(SHARED_PREFERENCES_VISLICE.charAt(SHARED_PREFERENCES_VISLICE.length() - 1) == '_') {
            SHARED_PREFERENCES_VISLICE += visliceName();
            ST_HIGH_SCORE += visliceName();
            ST_CURRENT_SCORE += visliceName();
            ST_PRESKOK += visliceName();
            ST_DVE_CRKI += visliceName();
            ST_CRKA += visliceName();
            ST_CURRENT_WORD += visliceName();
            ST_CURRENT_KNOWN_CHARS += visliceName();
            ST_CURRENT_ZGRESENIH += visliceName();
            ST_NEXT_PERK += visliceName();
        }
    }

    public void initialize_shared_preferences() {
    ...
    public void set_beseda() {

        mVislice.setImageResource(R.drawable.vislice1);

        beseda = besede.beseda(random.nextInt(besede.stevilo_besed()));
    ...
    public void refresh() {
        ...
        if(keyboard() == Keyboards.ENGLISH.ordinal()) {
            a.setAlpha(1.0F);
            b.setAlpha(1.0F);
            c.setAlpha(1.0F);
            cc.setAlpha(1.0F);
        ...
        else if(keyboard() == Keyboards.SLOVENIAN.ordinal()) {
            a.setAlpha(1.0F);
            b.setAlpha(1.0F);
            c.setAlpha(1.0F);
            cc.setAlpha(1.0F);
    ...
    public void delayed_refresh(int delay) {
    ...
    public void perform_clicking(char c) {
        if(keyboard() == Keyboards.ENGLISH.ordinal()) {
    ...
    public void check_if_in_word(final char c, View v) {
        ...
        if (st_zgresenih >= V_ST_ZGRESENIH) {
            ...
            handler.postDelayed(new Runnable() {
                ...
                public void run() {
                    reset_perks();
                    FragmentManager m = (FragmentManager) getCurrentFragmentManager();
