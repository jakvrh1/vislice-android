...
import com.jakvrh1.vislice.DialogScoreFragment;
import com.jakvrh1.vislice.R;
import com.jakvrh1.vislice.Razredi_Besede.Drzave;
...
public class VisliceDrzaveFragment extends Fragment {

    static public String SHARED_PREFERENCES_VISLICE = "sharedpreferences_vislice_drzave";
    static public String ST_HIGH_SCORE = "ST_HIGH_SCORE_DRZAVE";
    static public String ST_CURRENT_SCORE = "ST_CURRENT_SCORE_DRZAVE";
    static public String ST_PRESKOK = "ST_PRESKOK_DRZAVE";
    static public String ST_DVE_CRKI = "ST_DVE_CRKI_DRZAVE";
    static public String ST_CRKA = "ST_CRKA_DRZAVE";

    static public String ST_CURRENT_WORD = "ST_CURRENT_WORD_DRZAVE";
    static public String ST_CURRENT_KNOWN_CHARS = "ST_CURRENT_KNOWN_CHARS_DRZAVE";
    static public String ST_CURRENT_ZGRESENIH = "ST_ZGRESENIH_DRZAVE";
    static public String ST_NEXT_PERK = "ST_NEXT_PERK_DRZAVE";
    ...
    private Button a, b, c, cc, d, e, f, g, h, i, j, k, l, m, n, o, p, r, s, ss, t, u, v, z, zz;
    ...
    private Drzave drzave = null;
    private Random random = new Random(System.currentTimeMillis());

    @Override
    public void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        drzave = new Drzave(getActivity());
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.vislice_drzave_fragment, container, false);
        ...
        mCurrent = (TextView) view.findViewById(R.id.vislice_drzave_current);
    ...
    private void check_if_in_word(final char c, View v) {
        ...
        if (st_zgresenih >= V_ST_ZGRESENIH) {
            ...
            handler.postDelayed(new Runnable() {
                @Override
                public void run() {
                    FragmentManager m = VisliceDrzaveFragment.this.getFragmentManager();
